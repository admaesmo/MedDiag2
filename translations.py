translations = {
    "es": {
        ...
        "parkinson_audio_title": "Opcion A: Voz (DisVoice)",
        "parkinson_audio_label": "Graba o sube un audio (3-5 segundos) en WAV/OGG",
        "parkinson_audio_spinner": "Extrayendo 22 caracteristicas con DisVoice...",
        "parkinson_audio_success": "Se extrajeron las caracteristicas, listo para predecir.",
        "parkinson_audio_predict": "Predecir con audio",
        "parkinson_manual_title": "Opcion B: Formulario manual",
    ...
    "en": {
        ...
        "parkinson_audio_title": "Option A: Voice (DisVoice)",
        "parkinson_audio_label": "Record or upload audio (3-5 seconds) WAV/OGG",
        "parkinson_audio_spinner": "Extracting 22 features with DisVoice...",
        "parkinson_audio_success": "Features extracted, ready to predict.",
        "parkinson_audio_predict": "Predict with audio",
        "parkinson_manual_title": "Option B: Manual form",
